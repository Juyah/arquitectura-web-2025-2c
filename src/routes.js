...
router.put("/:id/offers/:offerId", offerController.updateOffer.bind(offerController));
...
router.put("/:id/questions/:questionId", questionController.updateQuestion.bind(questionController));
...
router.put("/:id/reviews/:reviewId", reviewController.updateReview.bind(reviewController));
